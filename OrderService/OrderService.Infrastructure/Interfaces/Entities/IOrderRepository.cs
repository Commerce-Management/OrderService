...
public interface IOrderRepository : IRepository<Order>
{
    ...
    public Task<IEnumerable<Order>> GetAllUserOrdersAsync(Guid userId, int page, int limit);
    ...
    public Task<IEnumerable<Order>> GetAllPaginatedAsync(int page, int limit);
}